package com.marketSpring.goods.dao;
...
public class GoodsDAOImpl  implements GoodsDAO{
	...
	@Override
	public GoodsVO selectGoodsDetailList(String goods_status) throws DataAccessException{
		GoodsVO goodsVO=(GoodsVO)sqlSession.selectOne("mapper.goods.selectGoodsDetailList",goods_status);
		return goodsVO;
	}
